@testset "GEOS functions" begin
    ...
    @test LibGEOS.geomToWKT(output_) == LibGEOS.geomToWKT(expected_)
    ...
    @test LibGEOS.geomToWKT(geom2_) == LibGEOS.geomToWKT(geom3_)
    LibGEOS.destroyGeom(geom1_)
    LibGEOS.destroyGeom(geom2_)
    ...
    @test LibGEOS.geomToWKT(geom3_) == "GEOMETRYCOLLECTION EMPTY"
    LibGEOS.destroyGeom(geom1_)
    LibGEOS.destroyGeom(geom2_)
    LibGEOS.destroyGeom(geom3_)
    ...
    geom2_ = LibGEOS.geomFromWKT("POINT(2 2)")
    geom3_ = LibGEOS.intersection(geom1_, geom2_)
    @test LibGEOS.geomToWKT(geom3_) == LibGEOS.geomToWKT(geom2_)
    LibGEOS.destroyGeom(geom1_)
    LibGEOS.destroyGeom(geom2_)
    LibGEOS.destroyGeom(geom3_)
    ...
    @test LibGEOS.geomToWKT(geom3_) == LibGEOS.geomToWKT(geom4_)
    LibGEOS.destroyGeom(geom1_)
    LibGEOS.destroyGeom(geom2_)
    LibGEOS.destroyGeom(geom3_)
    ...
    geom1_ = LibGEOS.geomFromWKT("LINESTRING EMPTY")
    geom2_ = LibGEOS.pointOnSurface(geom1_)
    @test LibGEOS.geomToWKT(geom2_) == "POINT EMPTY"
    ...
    @test LibGEOS.geomToWKT(geom2_) == "GEOMETRYCOLLECTION EMPTY"
    LibGEOS.destroyGeom(geom1_)
    LibGEOS.destroyGeom(geom2_)
